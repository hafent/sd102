 ...
 *
 * 按照规约分类,分成3类:
 * 1. 监视方向上的过程信息的应用服务数据单元 (数据返回帧)
 * 2. 监视方向上的系统信息的应用服务数据单元 (信息返回帧)
 * 3. 控制方向上的系统信息的应用服务数据单元 (读信息/数据帧)
 *
 * 其中:
